...
import type { ShiftWithDetails, Employee, Position, ShiftType } from "@shared/schema";
...
export default function Calendar() {
  ...
  const { data: shifts = [], isLoading: shiftsLoading } = useQuery<ShiftWithDetails[]>({
    queryKey: ["/api/shifts", currentDate.getMonth() + 1, currentDate.getFullYear()],
    queryFn: async () => {
    ...
    return (
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-neutral-500 mt-2">Cargando calendario...</p>
        </div>
      </div>
    );
  }
